...
const Homepage = () => {
    ...
    return (
        <SidebarLayout>
            ...
            {toastMessage && (
                <div className="fixed bottom-6 right-6 bg-[#8BDFDD] text-[#222] px-4 py-3 shadow-[0_8px_30px_rgb(0,0,0,0.12)] text-[13px] font-medium transition-all duration-300 z-[9999] flex items-center gap-2" style={{ animation: 'hpToastIn 0.3s ease-out' }}>
