                    ...
                    <div className="gs-upload-item" key={index}>
                        ...
                        <div className="gs-progress-wrapper">
                            ...
                            <div className="gs-check-icon" style={{ animationDelay: `${2 + (index * 0.5)}s` }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#1abc9c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                            </div>
                        </div>
                    </div>
                ))}
