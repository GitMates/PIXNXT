...
const IconFolderRemove = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" /><line x1="9" y1="14" x2="15" y2="8" /><line x1="15" y1="14" x2="9" y2="8" /></svg>
);
const IconMail = () => (
  ...
  return createPortal(
    <>
      ...
      <div
        ...
        style={{ top: layout.submenuTop, left: layout.submenuLeft, width: SUBMENU_WIDTH }}
        role="menu"
        onMouseEnter={pointerInside}
        onMouseLeave={pointerOutside}
      ...
      >
        <button
          type="button"
          className="cg-ctx-item"
          onMouseDown={(e) => e.stopPropagation()}
          onClick={run(onShareByEmail)}
        >
          <IconMail />
          Share by email
        </button>
        ...
        <button
          type="button"
          className="cg-ctx-item cg-ctx-item--whatsapp"
          onMouseDown={(e) => e.stopPropagation()}
          onClick={run(onShareWhatsApp)}
        >
          <IconWhatsApp />
          Share via WhatsApp
        </button>
...
export function FolderContextMenu({
  ...
  return (
    ...
    >
      ...
      <button type="button" className="cg-ctx-item" onClick={run(() => onQuickEdit?.(folder))}>
        <IconEdit />
        <span>Quick edit</span>
      </button>
      <button type="button" className="cg-ctx-item" onClick={run(() => onRemoveFolder?.(folder))}>
        <IconFolderRemove />
