          ...
          >
            ...
            <motion.div className="mb-10 flex justify-center gap-10">
              ...
              >
                ...
                <span className="gallery-body-text text-[10px] font-bold uppercase tracking-widest text-zinc-500">
                  Email
                </span>
              </button>
              <button
            ...
            <motion.div className="relative">
              ...
              <motion.div className="gallery-body-text relative flex justify-center text-[10px] font-bold uppercase tracking-widest text-zinc-400">
