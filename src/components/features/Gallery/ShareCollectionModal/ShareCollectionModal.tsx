          ...
          >
            ...
            <motion.div className="mb-8 text-center">
              ...
              <h3
                ...
                className="mb-2 text-xl font-serif text-zinc-900"
            ...
            <motion.div className="relative">
              ...
              <motion.div className="relative flex justify-center text-[10px] font-bold uppercase tracking-widest text-zinc-400">
            ...
            <motion.div className="mt-6 flex overflow-hidden rounded border border-zinc-200 p-1">
              <input
                ...
                readOnly
                value={shareUrl}
                className="flex-1 bg-zinc-50 px-3 text-sm text-zinc-500 outline-none"
              ...
              <button
                ...
                className={cn(
                  'flex items-center gap-2 rounded-sm px-4 py-2 text-xs font-bold uppercase tracking-wider transition-colors',
                  copied
