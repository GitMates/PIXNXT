...
function PreviewFrame({
  ...
  if (isMobile) {
    return (
      <div className={cn('cd-design-frame', className)}>
                  ...
                  <div className="cd-phone-chrome" aria-hidden="true">
                    ...
                    <span className="cd-phone-chrome__icons">
                      <svg viewBox="0 0 17 12" width="15" height="11" aria-hidden>
                        <rect x="0.5" y="7" width="3" height="4.5" rx="0.6" fill="currentColor" opacity="0.45" />
                        <rect x="4.5" y="5" width="3" height="6.5" rx="0.6" fill="currentColor" opacity="0.65" />
                        <rect x="8.5" y="2.75" width="3" height="8.75" rx="0.6" fill="currentColor" opacity="0.85" />
                      ...
                      <svg viewBox="0 0 25 12" width="22" height="11" aria-hidden>
                        <rect x="0.5" y="0.5" width="21" height="11" rx="2.2" stroke="currentColor" strokeOpacity="0.45" fill="none" />
                        <rect x="2" y="2" width="15" height="8" rx="1.2" fill="currentColor" />
                        <path d="M23 4.2v3.6a1.5 1.5 0 0 0 0-3.6z" fill="currentColor" opacity="0.5" />
                      </svg>
                    </span>
                  </div>
        ...
        <span className="cd-design-frame__label">Mobile</span>
      </div>
    );
  }
  ...
  return (
    <div className={cn('cd-design-frame', className)}>
      <div className="cd-laptop">
        <div className="cd-laptop__lid">
          <div className="cd-laptop__viewport">
            <div className="cd-browser-chrome" aria-hidden="true">
              ...
              <div className="cd-browser-chrome__url">
                <svg
                  className="cd-browser-chrome__lock"
                  viewBox="0 0 10 12"
                  width="7"
                  height="8"
                  aria-hidden
                >
                  <path
                    fill="currentColor"
                    d="M5 0a2.6 2.6 0 0 0-2.6 2.6V4H2a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1h-.4V2.6A2.6 2.6 0 0 0 5 0zm0 1.3c.72 0 1.3.58 1.3 1.3V4H3.7V2.6c0-.72.58-1.3 1.3-1.3z"
                  />
                </svg>
        ...
        <div className="cd-laptop__base" aria-hidden="true" />
      </div>
