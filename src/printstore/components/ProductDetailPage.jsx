...
//   const [selectedPaper, setSelectedPaper] = useState(MOCK_PAPERS[0]);
//   const [selectedFrame, setSelectedFrame] = useState(
//     product.id === 'float_frames' ? MOCK_FRAMES[5] : MOCK_FRAMES[0]
//   );
...
//   const isRoomPreview = activePreviewType === 'room' || (product.id === 'matted_collages' && activePreviewType === 'detail-0');
...
//                             onClick={() => {
//                               setActivePreviewTab('prints');
//                               setActivePreviewType(product.id === 'matted_collages' ? 'detail-1' : 'detail-0');
//                             }}
//                           >
//                             <span className="v-btn__content">
//                               <div className="pt-tab__content">
...
//                     <div 
//                       className="media-set-preview" 
//                       style={{ backgroundImage: `url(${activePreviewType === 'room' ? details.roomBackground : details.details[0].url})` }}
//                     >
//                       <div ref={containerRef} className="media-set-preview__composition-container" style={{ 
//                         left: (product.id === 'matted_frame' || product.id === 'matted_collages') ? '15.15%' : product.id === 'gallery_board' ? '69.5443%' : product.id === 'canvas' ? '9.05706%' : product.id === 'circular_frames' ? '58.2614%' : product.id === 'float_frames' ? '14.0089%' : '14.0089%', 
//                         top: (product.id === 'matted_frame' || product.id === 'matted_collages') ? '12.05%' : product.id === 'gallery_board' ? '20.5828%' : product.id === 'canvas' ? '7.76236%' : product.id === 'circular_frames' ? '26.0121%' : product.id === 'float_frames' ? '11.7311%' : '15.2589%', 
//                         width: (product.id === 'matted_frame' || product.id === 'matted_collages') ? '16.31%' : product.id === 'gallery_board' ? '11.6514%' : product.id === 'canvas' ? '28.5459%' : product.id === 'circular_frames' ? '12.4772%' : product.id === 'float_frames' ? '18.6422%' : '18.6422%', 
//                         height: (product.id === 'matted_frame' || product.id === 'matted_collages') ? '34.57%' : product.id === 'gallery_board' ? '24.6944%' : product.id === 'canvas' ? '43.2153%' : product.id === 'circular_frames' ? '18.7158%' : product.id === 'float_frames' ? '35.2778%' : '28.2222%', 
//                         position: 'absolute' 
//                       }}>
//                         {product.id === 'matted_collages' ? (
//                           <div 
//                             className="product-card-matted_collages" 
//                             style={{ 
//                               '--frame-color': selectedFrame?.color || 'transparent',
//                               width: '215px',
//                               height: '280px',
//                               transform: `scale(${compositionWidth / 215})`,
//                               transformOrigin: 'top left',
...
//                             }}
//                           >
//                             <div className="product-image-box" style={{ width: '100%', height: '100%', padding: 0, background: 'transparent' }}>
...
//                           </div>
//                         ) : (
//                           <div className="composition-preview" style={{ width: '100%', height: '100%', position: 'relative' }}>
//                             <div className="composition-preview__composition" style={{ 
//                               aspectRatio: (product.id === 'matted_frame' || product.id === 'matted_collages') ? '0.783494 / 1' : product.id === 'gallery_board' ? '0.714286 / 1' : product.id === 'float_frames' ? '0.836642 / 1' : '1 / 1', 
//                               width: '100%', 
//                               height: '100%', 
//                               position: 'relative',
//                               ...(product.id === 'canvas' && { clipPath: 'inset(17.28%)', borderRadius: '0.13px' })
...
//                                 ...(product.id === 'gallery_board' 
//                                     ? { width: '78.33%', height: '84.14%', top: '7.92%', left: '10.83%' }
//                                     : product.id === 'matted_frame' || product.id === 'frames' || product.id === 'matted_collages'
//                                     ? { width: '69.7802%', height: '76.3746%', top: '11.8127%', left: '15.1099%' }
//                                     : product.id === 'circular_frames'
//                                     ? { width: '80%', height: '80%', top: '10%', left: '10%', borderRadius: '50%' }
//                                     : product.id === 'float_frames'
...
//                                 }}>
//                                   {product.id === 'float_frames' ? (
//                                     /* Float frames: use img tag so SVG deckled-edge filter works */
//                                     <img 
//                                       src={product.image}
//                                       alt=""
//                                       className="float-frame-preview-photo"
...
//                           const lastIdx = details.details.length - 1;
//                           setActivePreviewType(`detail-${lastIdx}`);
//                           if (product.id === 'matted_collages' && lastIdx === 0) {
//                             setActivePreviewTab('wall');
//                           } else {
//                             setActivePreviewTab('prints');
//                           }
...
//                             const newIdx = idx - 1;
//                             setActivePreviewType(`detail-${newIdx}`);
//                             if (product.id === 'matted_collages' && newIdx === 0) {
//                               setActivePreviewTab('wall');
//                             } else {
//                               setActivePreviewTab('prints');
//                             }
...
//                           left: (product.id === 'matted_frame' || product.id === 'matted_collages') ? '15.15%' : product.id === 'gallery_board' ? '69.5443%' : product.id === 'canvas' ? '9.05706%' : '14.0089%', 
//                           top: (product.id === 'matted_frame' || product.id === 'matted_collages') ? '12.05%' : product.id === 'gallery_board' ? '20.5828%' : product.id === 'canvas' ? '7.76236%' : '15.2589%', 
//                           width: (product.id === 'matted_frame' || product.id === 'matted_collages') ? '16.31%' : product.id === 'gallery_board' ? '11.6514%' : product.id === 'canvas' ? '28.5459%' : '18.6422%', 
//                           height: (product.id === 'matted_frame' || product.id === 'matted_collages') ? '34.57%' : product.id === 'gallery_board' ? '24.6944%' : product.id === 'canvas' ? '43.2153%' : '28.2222%', 
//                           position: 'absolute' 
//                         }}>
//                           {product.id === 'matted_collages' ? (
//                             <div 
...
//                             <div className="composition-preview" style={{ width: '100%', height: '100%', position: 'relative' }}>
//                               <div className="composition-preview__composition" style={{ 
//                                 aspectRatio: (product.id === 'matted_frame' || product.id === 'matted_collages') ? '0.783494 / 1' : product.id === 'gallery_board' ? '0.714286 / 1' : '1 / 1', 
//                                 width: '100%', 
//                                 height: '100%', 
//                                 position: 'relative',
//                                 ...(product.id === 'canvas' && { clipPath: 'inset(17.28%)', borderRadius: '0.13px' })
//                               }}>
//                                 <div className="composition-preview__printable-area" style={{ 
//                                   width: (product.id === 'matted_frame' || product.id === 'matted_collages') ? '69.7802%' : product.id === 'circular_frames' ? '80%' : '100%', 
//                                   height: (product.id === 'matted_frame' || product.id === 'matted_collages') ? '76.3746%' : product.id === 'circular_frames' ? '80%' : '100%', 
//                                   top: (product.id === 'matted_frame' || product.id === 'matted_collages') ? '11.8127%' : product.id === 'circular_frames' ? '10%' : '0%', 
//                                   left: (product.id === 'matted_frame' || product.id === 'matted_collages') ? '15.1099%' : product.id === 'circular_frames' ? '10%' : '0%',
//                                   zIndex: 2,
//                                   position: 'absolute'
//                                 }}>
//                                   <div className="composition-preview-box" style={{ 
//                                     width: product.id === 'gallery_board' ? '78.3333%' : product.id === 'circular_frames' ? '70%' : '100%', 
//                                     height: product.id === 'gallery_board' ? '84.1429%' : product.id === 'circular_frames' ? '70%' : '100%', 
//                                     top: product.id === 'gallery_board' ? '7.90476%' : product.id === 'circular_frames' ? '15%' : '0%', 
//                                     left: product.id === 'gallery_board' ? '10.8%' : product.id === 'circular_frames' ? '15%' : '0%',
//                                     position: 'absolute',
//                                     ...(product.id === 'circular_frames' && { borderRadius: '50%', overflow: 'hidden' })
//                                   }}>
//                                     <div 
//                                       className="composition-preview-box__image" 
//                                       style={{ 
...
//                                 left: 0,
//                                 zIndex: 1,
//                                 scale: activePreviewType === 'room' ? '0.654443' : '1',
...
//                               </div>
//                             ) : product.id === 'circular_frames' ? (
//                               <div className="circular-frame-pdp-overlay composition-preview__overlay" style={{ width: '100%', height: '100%', position: 'absolute', top: 0, left: 0, zIndex: 1, pointerEvents: 'none' }}>
//                                 {selectedFrame?.id !== 'frame_none' ? (
//                                   <>
//                                     <div style={{ position: 'absolute', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1 }}>
//                                       <div style={{ width: '74%', height: '74%', position: 'relative' }}>
//                                         <CircularDeckleSvg />
//                                       </div>
//                                     </div>
//                                     <img src={circularRoom} alt="" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'contain', zIndex: 2 }} />
//                                   </>
//                                 ) : (
...
//                               </div>
//                             ) : product.id === 'acrylic_prints' ? (
//                               <div className="acrylic-print-pdp-overlay composition-preview__overlay" style={{
//                                 width: '100%',
//                                 height: '100%',
//                                 position: 'absolute',
//                                 top: 0,
...
//                       {details.details.map((item, idx) => {
//                         const isSecondWallThumbnail = product.id === 'matted_collages' && idx === 0;
...
//                           >
//                             <div 
//                               className="media-set-preview-thumb-bg" 
//                               style={{ 
//                                 backgroundImage: `url(${item.url})`, 
//                                 width: '100%', 
//                                 height: '100%', 
...
//     featureDesc: "An elegant way to celebrate multiple memories together in one frame. Displays up to three photos set inside custom bevel cut openings in a single mat board.",
//     details: [
//       { name: "Wall Frame", url: collageRoom },
//       { name: "Product Front", "url": "https://pictimecloudaf-pub-g3csanfebyefg3dm.a02.azurefd.net/pictures/scripts/platform2/resources/stores/4/shop/data-structures/fulfillers/0/specs/mattedcollages_3opening_std/lowres/pdp_s_mcoll3_lightwood_01.webp" },
//       { name: "Corner Profile", "url": "https://pictimecloudaf-pub-g3csanfebyefg3dm.a02.azurefd.net/pictures/scripts/platform2/resources/stores/4/shop/data-structures/fulfillers/0/specs/mattedcollages_3opening_std/lowres/bayphoto-mattedcollage-lightwood-2.jpg" }
//     ]
//   },
//   gallery_board: {
//     heroImage: "https://pictimecloudaf-pub-g3csanfebyefg3dm.a02.azurefd.net/pictures/scripts/platform2/resources/stores/4/shop/data-structures/resources/modeling_resources/pdp_bg_small04.webp",
...
//       <div className="pdp-products-page__content">
//         {/* 2. Intro Fold - SKIPPED FOR MATTED COLLAGES */}
//         {product.id !== 'matted_collages' && (
//           <div className="pdp-intro-container">
//             <div className="pdp-intro">
//               <div className="pdp-intro__left-section" style={{ backgroundImage: `url(${details.heroImage})` }}>
...
//         {/* 3. Closeup / Details Fold - SKIPPED FOR MATTED COLLAGES */}
//         {product.id !== 'matted_collages' && (
//           <div className="pdp-closeup PDP-5-1-1">
//             <div className="pdp-closeup__inner">
//               <div className="pdp-products-closeup">
...
//                       onClick={() => {
//                         if (activePreviewType === 'room') {
//                           const lastIdx = product.id === 'matted_collages' ? WALL_OPTIONS.length - 1 : details.details.length - 1;
//                           setActivePreviewType(`detail-${lastIdx}`);
//                           setActivePreviewTab('prints');
//                         } else {
//                           const idx = parseInt(activePreviewType.split('-')[1]);
...
//                     <div className="pt-tiny-swiper__content media-set__swiper--tiny">
//                       {/* ALWAYS Wall Room Display Thumbnail */}
//                       {product.id === 'matted_collages' ? (
//                         WALL_OPTIONS.map((wall, idx) => (
//                           <div 
//                             key={wall.id}
//                             className={`media-set-image BS-22-1-1 ${activePreviewType === 'room' && selectedWall.id === wall.id ? 'media-set-image--selected' : ''}`}
//                             onClick={() => {
...
//                             style={{ cursor: 'pointer', overflow: 'hidden' }}
//                           >
//                             <div className="media-set-preview-thumb-bg" style={{ backgroundImage: `url(${wall.url})`, width: '100%', height: '100%', backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
//                           </div>
//                         ))
//                       ) : (
//                         <>
...
//                         } else {
//                           const idx = parseInt(activePreviewType.split('-')[1]);
//                           const maxIdx = product.id === 'matted_collages' ? WALL_OPTIONS.length - 1 : details.details.length - 1;
//                           if (idx === maxIdx) {
//                             setActivePreviewType('room');
//                             setActivePreviewTab('wall');
//                           } else {
...
//                       {/* PROPORTIONAL SCHEMATIC DRAWING BOX PLACED PRECISELY UNDER COLOR CONFIGURATOR */}
//                       {product.id === 'matted_collages' && (
//                         <div className="matted-collage-blueprint-spec" style={{
//                           marginTop: '24px',
...
//                           }}>
//                             {/* Inner custom grid indicators */}
//                             <div style={{ width: '100%', height: 'calc(50% - 4px)', border: '1px dashed #999', backgroundColor: '#ffffff', position: 'relative' }}>
//                               <span style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '9px', color: '#888' }}>10x10</span>
//                             </div>
//                             <div style={{ width: '100%', height: 'calc(50% - 4px)', border: '1px dashed #999', backgroundColor: '#ffffff', position: 'relative' }}>
//                               <span style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '9px', color: '#888' }}>10x10</span>
//                             </div>
//                             {/* Absolute size metric ribbons */}
//                             <div style={{ position: 'absolute', bottom: '-20px', left: '0', width: '100%', textAlign: 'center', fontSize: '10px', color: '#666', fontWeight: 500 }}>21.5 cm</div>
//                             <div style={{ position: 'absolute', right: '-48px', top: '0', height: '100%', display: 'flex', alignItems: 'center', fontSize: '10px', color: '#666', fontWeight: 500 }}>28.0 cm</div>
//                           </div>
//                           <div style={{ fontSize: '12px', color: '#666', marginTop: '36px', textAlign: 'center', letterSpacing: '0.02em' }}>
//                             Composition structure layout: Two vertical 10x10 openings inside full-mat windowing.
//                           </div>
//                         </div>
//                       )}
