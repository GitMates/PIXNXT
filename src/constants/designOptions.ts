import { CoverStyleId, FontId, PaletteId, AspectRatioId } from '../types/design.types';
...
export const TYPOGRAPHY_OPTIONS: { id: FontId; name: string; desc: string; sample: string }[] = [
...
export const COLOR_PALETTES: { id: PaletteId; name: string; colors: string[] }[] = [
...
export const THUMBNAIL_SIZES: { id: 'x-small' | 'small' | 'regular' | 'large'; name: string }[] = [
...
export const GRID_SPACING: { id: 'none' | 'small' | 'regular' | 'large'; name: string }[] = [
    { id: 'none', name: 'None' },
    { id: 'small', name: 'Small' },
    { id: 'regular', name: 'Regular' },
    { id: 'large', name: 'Large' },
